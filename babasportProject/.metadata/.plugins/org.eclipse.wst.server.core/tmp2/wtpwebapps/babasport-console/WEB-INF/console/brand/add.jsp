...
<div class="body-box" style="float:right">
	<!-- 此处的multipart/form-data进行表单的文件上传,添加此属性后,后台 无法获取到数据-->
	<form id="jvForm" action="/console/brand/addBrand.do" method="post" enctype="multipart/form-data">
			...
			<tbody>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h"></td>
						...
						<input type="hidden" name="imgUrl" id="imgUrl"></input>
