                              ...
                              <tr>
                                ...
                                <td>
                                	<ul class="nav-menu">
										...
										<li class="sep"></li><li class="normal" id="tb_15" onclick="HoverLi(15);"><a href="frame/product_main.do" target="mainFrame">支付</a></li>
										<li class="sep"></li><li class="normal" id="tb_16" onclick="HoverLi(16);"><a href="frame/product_main.do" target="mainFrame">资源</a></li>
										<li class="sep"></li><li class="normal" id="tb_17" onclick="HoverLi(17);"><a href="frame/product_main.do" target="mainFrame">辅助</a></li>
										<li class="sep"></li><li class="normal" id="tb_18" onclick="HoverLi(18);"><a href="frame/product_main.do" target="mainFrame">维护</a></li>
										<li class="sep"></li><li class="normal" id="tb_19" onclick="HoverLi(19);"><a href="frame/product_main.do" target="mainFrame">生成</a></li>
										<li class="sep"></li><li class="normal" id="tb_20" onclick="HoverLi(20);"><a href="frame/product_main.do" target="mainFrame">用户</a></li>
										<li class="sep"></li><li class="normal" id="tb_21" onclick="HoverLi(21);"><a href="frame/product_main.do" target="mainFrame">配置</a></li>
                                    </ul>
                                </td>
                              </tr>
                            </table>
